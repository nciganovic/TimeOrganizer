...
namespace TimeOrganizer.Migrations
{
    ...
    [Migration("20201216164652_AddFinishedTaskTable")]
    partial class AddFinishedTaskTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TimeOrganizer.Model.Tables.FinishedTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TimeOrganizer.Model.Tables.MailRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TimeOrganizer.Model.Tables.FinishedTask", b =>
                {
                    b.HasOne("TimeOrganizer.Model.Tables.Task", "Task")
                        .WithOne("FinishedTask")
                        .HasForeignKey("TimeOrganizer.Model.Tables.FinishedTask", "TaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
